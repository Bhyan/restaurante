<%@ page import="intersistemas.Autor; intersistemas.Livro" %>
...
<div class="fieldcontain ${hasErrors(bean: livroInstance, field: 'autor', 'error')} required">
	...
	<g:select name="autor.id" value="${livroInstance?.autor?.id}" from="${intersistemas.Autor?.list()}" optionKey="id" optionValue="nome" />
