	...
	<body>
		...
		<div id="show-autor" class="content scaffold-show" role="main">
			...
			<ol class="property-list autor">
				...
				<g:if test="${autorInstance?.idade}">
				<li class="fieldcontain">
					<span id="idade-label" class="property-label"><g:message code="autor.idade.label" default="Idade" /></span>
					
						<span class="property-value" aria-labelledby="idade-label"><g:fieldValue bean="${autorInstance}" field="idade"/></span>
